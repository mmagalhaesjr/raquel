        ...
        <StyledSobre id="sobre">
            ...
            <section id='container'>
                ...
                <div id='texto'>
                    ...
                    <p>
                        Graduada em Serviço Social pela Universidade Federal de Juiz de Fora (UFJF). Professora
                        universitária com sólida formação acadêmica, com pós-graduação em Diversidade, Etnicidade e Cultura, além de especialização em Psicologia Organizacional. É autora do capítulo IV do livro “A dimensão técnico-operativa no Serviço Social: desafios contemporâneos”, intitulado “Serviço Social, projeto ético-político e cultura: as intersecções na intervenção do assistente social”, publicado pela editora UFJF.
                    </p>
                    <p>
